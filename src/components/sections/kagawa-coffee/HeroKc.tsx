...
export function HeroKc() {
  const brandColor = "var(--kagawacoffee-color)";
  
  return (
    <section className="relative pt-20 pb-20 lg:pt-24 lg:pb-28 overflow-hidden bg-amber-50/30">      
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        >
          ...
          <div className="hidden sm:block w-px h-4 bg-amber-200" />
          
          <div className="flex items-center text-sm text-amber-700/60 font-medium space-x-2">
            <Link href="/" className="hover:text-amber-900 transition-colors">Beranda</Link>
            <ChevronRight className="w-4 h-4" />
            <Link href="/paket-kemitraan" className="hover:text-amber-900 transition-colors">Paket Kemitraan</Link>
            <ChevronRight className="w-4 h-4" />
            <span className="text-amber-900 font-bold">Kagawa Coffee Conner</span>
          </div>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="flex flex-col items-center text-center lg:items-start lg:text-left relative z-10">
            ...
            >
              Japanese <span style={{ color: brandColor }}>Coffee Shop</span> Masa Kini
            </motion.h1>
            ...
            >
              Hadirkan nuansa kedai kopi khas Jepang dengan kualitas specialty grade. Mudah dijalankan dengan sistem semi-otomatis dan dukungan profesional.
            </motion.p>
            ...
            >
                {/* Stat 1 */}
                <div className="bg-white p-5 rounded-3xl border border-amber-50 shadow-sm flex flex-col items-center lg:items-start text-center lg:text-left transition-transform hover:-translate-y-1 duration-300">
                  ...
                  <h4 className="text-2xl font-black text-slate-900 mb-1">{"< 1.5"} <span className="text-xl">Tahun</span></h4>
                ...
                {/* Stat 3 */}
                <div className="bg-white p-5 rounded-3xl border border-amber-50 shadow-sm flex flex-col items-center lg:items-start text-center lg:text-left col-span-2 sm:col-span-1 transition-transform hover:-translate-y-1 duration-300">
                  <div className="w-12 h-12 rounded-2xl flex items-center justify-center mb-4" style={{ backgroundColor: `${brandColor}15`, color: brandColor }}>
          ...
          >            
            <div className="relative w-full h-[350px] sm:h-[450px] lg:h-[600px] rounded-[3rem]">
              <Image 
                src="/assets/img/gerai/kagawa-coffee-conner.webp" 
                alt="Highlight Kagawa Coffee Product"
                fill
