        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            <p className="text-lg text-slate-600 mb-10 max-w-2xl text-balance">
              Bangun kedai kopi Anda dengan mudah. Raih keuntungan maksimal dengan brand Kagawa Coffee Conner beserta segala kemudahan perlengkapan dan operasionalnya.
            </p>
          ...
          >
            <div className="bg-slate-50 border border-slate-100 rounded-[2.5rem] p-8 md:p-10 shadow-xl relative overflow-hidden group">
              <div className="relative z-10 text-center flex flex-col items-center">
                ...
                <p className="text-xs text-slate-400 mt-5 font-medium">FREE 100 Porsi Minuman Coffee. Promo saat Grand Opening</p>
              </div>
            </div>
          </motion.div>
        </div>
