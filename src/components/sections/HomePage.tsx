  ...
  return (
    <section 
      ...
      >
        ...
        >
          <button className="bg-red-600 hover:bg-red-700 text-white px-8 py-3 rounded-full font-medium transition-all">
            Gabung Kemitraan
          </button>
          <button className="hover:bg-white text-slate-100 hover:text-slate-900 px-8 py-3 rounded-full font-medium border border-gray-200 transition-all shadow-md">
