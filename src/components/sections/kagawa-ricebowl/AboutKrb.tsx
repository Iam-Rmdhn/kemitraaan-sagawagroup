    ...
    <section className="relative py-24 md:py-32 overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl text-center">
        ...
        >
          ...
          >
            Premium Japanese Fusion Franchise
          </motion.span>
          ...
          >
            <p>
              Kagawa Rice Bowl menggabungkan kelezatan autentik Jepang dengan sentuhan unik Nusantara, menciptakan sebuah konsep bisnis kuliner yang kuat dan mudah diterima pasar.
            </p>
            <p className="opacity-90">
              Dengan menu andalan yang inovatif, kami tidak hanya membangun basis pelanggan yang loyal, tetapi juga membuka sebuah peluang nyata untuk kesuksesan bersama di industri kuliner yang terus berkembang.
            </p>
          </motion.div>
        </motion.div>
      </div>
