        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            <p className="text-lg text-slate-600 mb-10 max-w-2xl text-balance">
              Dapatkan fasilitas terlengkap dan dukungan penuh dari kami untuk memastikan operasional gerai Kagawa Rice Bowl Anda berjalan lancar sejak hari pertama.
            </p>
            ...
            <div className="bg-slate-50 border border-slate-100 rounded-[2.5rem] p-8 md:p-10 shadow-xl relative overflow-hidden group">
              <div className="relative z-10 text-center flex flex-col items-center">
                ...
                <FluidLink 
                  ...
                  onClick={() => {
                    trackEvent("Contact", { content_name: "Kagawa Rice Bowl" });
                    trackCustomEvent("WhatsAppClick", { source: "krb_benefit" });
                  }}
                >
