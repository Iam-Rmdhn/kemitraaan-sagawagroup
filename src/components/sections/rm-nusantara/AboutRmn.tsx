    ...
    <section className="relative py-24 md:py-32 overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl text-center">
        ...
        >
          ...
          >
            <p>
              RM Nusantara menawarkan kelezatan otentik Indonesia dengan berbagai masakan daerah, menciptakan sebuah konsep bisnis kuliner yang melestarikan kekayaan kuliner nusantara.
            </p>
            <p className="opacity-90">
              Dengan menu andalan yang bervariasi, kami tidak hanya memperkenalkan cita rasa lokal, tetapi juga membuka sebuah peluang nyata untuk kesuksesan bersama di industri kuliner yang terus berkembang.
            </p>
          </motion.div>
        </motion.div>
      </div>
