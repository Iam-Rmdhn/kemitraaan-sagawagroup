      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        >
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-black text-slate-900 mb-4 drop-shadow-sm tracking-tight text-balance">
            Menu <span style={{ color: secondColor }}>Kombinasi</span> <span style={{ color: brandColor }}>Unggulan</span>
          </h2>
          <p className="text-lg text-slate-600 max-w-2xl mx-auto text-balance">
            Perpaduan sempurna antara kelezatan Rice Bowl autentik Jepang dan kesegaran Artisan Coffee premium.
          </p>
        </motion.div>
        ...
        <div className="flex flex-wrap justify-center gap-6 sm:gap-8">
          {menus.map((menu, index) => (
            ...
            >
              ...
              <h3 className="text-center font-bold text-slate-800 text-sm sm:text-base group-hover:text-emerald-700 transition-colors">
                {menu.name}
              </h3>
            </motion.div>
          ))}
