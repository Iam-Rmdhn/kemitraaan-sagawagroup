      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        >
          ...
          <div className="flex items-center text-sm text-slate-500 font-medium space-x-2">
            ...
            <ChevronRight className="w-4 h-4" />
            <span className="text-slate-900 font-bold">Kagawa Coffee & Rice Bowl Conner</span>
          </div>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="flex flex-col items-center text-center lg:items-start lg:text-left relative z-10">
            ...
            <motion.div
              ...
              className="flex items-center justify-center lg:justify-start gap-4 sm:gap-6 mb-6 lg:mb-8 mx-auto lg:mx-0"
            >
              ...
              <span className="text-xl sm:text-2xl font-black text-slate-300">X</span>
            ...
            <motion.h1 
              ...
              className="text-3xl sm:text-4xl md:text-5xl lg:text-5xl xl:text-6xl font-black text-slate-900 mb-4 lg:mb-6 drop-shadow-sm tracking-tight text-balance leading-tight"
            >
              Kombinasi Sempurna <span style={{ color: secondColor }}>Makan & Ngopi</span>
            </motion.h1>
            ...
            >
              Maksimalkan profit dengan dua konsep F&B paling diminati. Integrasi menu Rice Bowl dan Artisan Coffee, semuanya dalam satu naungan Manajemen Sagawa Group.
            </motion.p>
            ...
            >
                ...
                <div className="bg-white p-5 rounded-3xl border border-slate-100 shadow-sm flex flex-col items-center lg:items-start text-center lg:text-left col-span-2 sm:col-span-1 transition-transform hover:-translate-y-1 duration-300">
                  <div className="w-12 h-12 rounded-2xl flex items-center justify-center mb-4" style={{ backgroundColor: `${secondColor}15`, color: secondColor }}>
          ...
          >            
            <div className="relative w-full h-[350px] sm:h-[450px] lg:h-[600px] rounded-[3rem]">
              <Image 
                src="/assets/img/gerai/coffee-ricebowl.webp" 
                alt="Highlight Kagawa Coffee & Rice Bowl Product"
                fill
