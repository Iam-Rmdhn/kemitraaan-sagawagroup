      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        >
          ...
          <div className="flex items-center text-sm text-slate-500 font-medium space-x-2">
            ...
            <ChevronRight className="w-4 h-4" />
            <span className="text-slate-900 font-bold">Independent Brand</span>
          </div>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="flex flex-col items-center text-center lg:items-start lg:text-left relative z-10">
            ...
            >
              <Image 
                src="/assets/logos/independent-brand.webp" 
                alt="Independent Brand Logo"
                fill
            ...
            >
              Bangun <span style={{ color: brandColor }}>Brand Impian</span> Anda Sendiri
            </motion.h1>
            ...
            >
              Wujudkan visi kuliner unik Anda dengan dukungan penuh dari manajemen dan akses supply chain Sagawa Group.
            </motion.p>
            ...
            >
                ...
                <div className="bg-white p-5 rounded-3xl border border-slate-100 shadow-sm flex flex-col items-center lg:items-start text-center lg:text-left transition-transform hover:-translate-y-1 duration-300">
                  ...
                  <h4 className="text-2xl font-black text-slate-900 mb-1">Custom</h4>
                  <p className="text-[11px] sm:text-xs font-bold text-slate-400 uppercase tracking-widest leading-snug">Konsep Bisnis</p>
                </div>
                ...
                <div className="bg-white p-5 rounded-3xl border border-slate-100 shadow-sm flex flex-col items-center lg:items-start text-center lg:text-left transition-transform hover:-translate-y-1 duration-300">
                  ...
                  <h4 className="text-2xl font-black text-slate-900 mb-1">Tailored</h4>
                ...
                <div className="bg-white p-5 rounded-3xl border border-slate-100 shadow-sm flex flex-col items-center lg:items-start text-center lg:text-left col-span-2 sm:col-span-1 transition-transform hover:-translate-y-1 duration-300">
                  ...
                  <h4 className="text-2xl font-black text-slate-900 mb-1">100%</h4>
                  <p className="text-[11px] sm:text-xs font-bold text-slate-400 uppercase tracking-widest leading-snug">Hak Milik</p>
                </div>
            </motion.div>
          </div>
          ...
          >            
            <div className="relative w-full rounded-4xl sm:rounded-4xl p-4 sm:p-2 mb-6 pointer-events-none drop-shadow-xl hover:drop-shadow-2xl transition-all duration-500 hover:-translate-y-2 group">
              <Image 
                src="/assets/img/gerai/indepandent.webp" 
                alt="Highlight Independent Brand Product"
                width={1200}
                height={600}
